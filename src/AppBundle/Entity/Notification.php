...
class Notification
{
     ...
     * @var int
     *
     * @ORM\Column(name="active", type="integer", columnDefinition="ENUM('1', '0')")
     */
    private $active;
     ...
     * @var int
     *
     * @ORM\Column(name="pushed", type="integer", columnDefinition="ENUM('1', '0')")
     */
    private $pushed;
     ...
     * @ORM\PrePersist
     */
    public function setPushedValue()
    {
        $this->pushed = 0;
    }
