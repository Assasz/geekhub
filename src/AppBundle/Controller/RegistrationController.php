...
class RegistrationController extends BaseController
{
    ...
    /**
     * For Ajax validation.
     * @Route("/signup/check-email-ajax",  name="signup_check_email_ajax", options={"expose"=true})
     */
    public function checkEmailAjaxAction(Request $request)
    {
